...
BuildRequires: gcc-c++ gcc gcc-c++ make flac-devel libogg-devel libvorbis-devel wxGTK-devel >= 2.8 boost-devel file-devel lzo-devel bzip2-devel zlib-devel gettext-devel ruby libcurl-devel
