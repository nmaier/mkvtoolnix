...
BuildRequires: gcc-c++ gcc gcc-c++ make flac-devel libogg-devel libvorbis-devel wxGTK-devel >= 2.6 boost-devel file lzo-devel bzip2-devel zlib-devel expat-devel gettext-devel
