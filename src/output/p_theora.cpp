...
theora_video_packetizer_c::extract_aspect_ratio() {
  if (display_dimensions_or_aspect_ratio_set() || (NULL == ti.m_private_data) || (0 == ti.m_private_size))
    return;

  memory_cptr private_data         = memory_cptr(new memory_c(ti.m_private_data, ti.m_private_size, false));
