...
public:
  xtr_wav_c(const string &codec_id, int64_t tid, track_spec_t &tspec);
...
private:
  ...
  binary m_version[2];
  mm_file_io_c *m_corr_out;
  int m_channels;

public:
  xtr_wavpack4_c(const string &codec_id, int64_t tid, track_spec_t &tspec);
