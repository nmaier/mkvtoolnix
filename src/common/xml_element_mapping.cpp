...
xml_element_map_init() {
  static parser_element_t _chapter_elements[] = {
    ...
    {"EditionEntry", EBMLT_MASTER, 1, 0, 0, no_id, NULL, NULL,
     NULL},
    {"EditionUID", EBMLT_UINT, 2, 0, NO_MAX_VALUE, no_id, NULL, NULL,
     NULL},
    ...
    {"ChapterAtom", EBMLT_MASTER, 2, 0, 0, no_id, NULL, NULL,
     NULL},
